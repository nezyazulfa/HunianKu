...
class _EditKostPageState extends State<EditKostPage> {
  ...
  void initState() {
    ...
    // 1. Parsing Kategori (Putra/Putri/Campur lama)
    ...
    // 2. Parsing Harga (Memecah "Rp 1.000.000/bulan" menjadi "1.000.000" dan "/bulan")
    ...
    _hargaController = TextEditingController(text: priceNumber); // Masukkan angka bersih
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              // --- STATUS KOST (TETAP ADA DI HALAMAN EDIT) ---
